...
ICS46_DYNAMIC_FACTORY_REGISTER(OthelloAI,othelloz::myOthelloAI,"Not Smart my AI (Required)");
//Choose the currentSide.
OthelloCell othelloz::myOthelloAI::chooseSide(const OthelloGameState& state)
{
    OthelloCell myColor;
...
vector<pair<int,int>> othelloz::myOthelloAI::getValidMoves(const OthelloGameState& state)
{
...
pair<int, int> othelloz::myOthelloAI::chooseMove(const OthelloGameState& state)
{
    int best_score = -3000;
...
bool othelloz::myOthelloAI::myTurn(const OthelloGameState& state,OthelloCell myColor)
{
...
int othelloz::myOthelloAI::search(const OthelloGameState& state, int depth, OthelloCell myColor)
{
...
int othelloz::myOthelloAI::eval(const OthelloGameState& state, OthelloCell myColor)
{
    int result = 0;
